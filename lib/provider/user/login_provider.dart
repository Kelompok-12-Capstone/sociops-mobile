...
import 'package:sociops/provider/user/save_toke.dart';
...
import '../../screen/fitur_organization/organization.dart';
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('Email Anda Belum Terdaftar', style: FontFamily().primary),
          actions: [
            TextButton(
              onPressed: () {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('Password yang Anda Masukkan Salah', style: FontFamily().primary),
          actions: [
            TextButton(
              onPressed: () {
                Navigator.of(context).pop();
