...
import '../componen/TeksFormField.dart';
import 'Pengajuan_donasi.dart';
          ...
          Center(
            child: Padding(
              ...
              child: Column(
               ...
               TeksFormField(hinText: "Tulis Nominal Donasi",),
                  ButtonPrimay(
                    teks: "Selanjutnya",
                    onPressed: () {
                      showDialog(
                          ...
                          builder: (_) => NetworkGiffDialog(
                                ...
                                description: Text(
                                  ...
                                  textAlign: TextAlign.center, style: FontFamily().reguler.copyWith(fontSize: 14)
                                ),
